...
if __name__ == '__main__':
    ...
    parser.add_argument('--cnn_detector', default="/saltpool0/data/sungbin/CVPR24/lip2speech/checkpoints/dlib/mmod_human_face_detector.dat",type=str, help='path to cnn detector (download and unzip from: http://dlib.net/files/mmod_human_face_detector.dat.bz2)')
    parser.add_argument('--face_predictor', default="/saltpool0/data/sungbin/CVPR24/lip2speech/checkpoints/dlib/shape_predictor_68_face_landmarks.dat",type=str, help='path to face predictor (download and unzip from: http://dlib.net/files/shape_predictor_68_face_landmarks.dat.bz2)')
    ...
    import skvideo.io
    vid_dir = os.path.join(args.root, "original")
    detect_face_landmarks(args.face_predictor, args.cnn_detector, vid_dir, args.landmark, args.manifest, args.rank, args.nshard)
