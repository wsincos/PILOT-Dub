...
def load_args(default_config=None):
    ...
    # -- mean face utils
    parser.add_argument('--mean_face', type=str, default="/saltpool0/data/sungbin/CVPR24/lip2speech/checkpoints/dlib/20words_mean_face.npy",help='reference mean face (download from: https://github.com/mpc001/Lipreading_using_Temporal_Convolutional_Networks/blob/master/preprocessing/20words_mean_face.npy)')
    # -- mouthROIs utils
